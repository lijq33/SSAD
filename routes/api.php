...
Route::get('crisis', 'ReportCrisisController@index');
Route::post('crisis/{crisis}', 'ReportCrisisController@update');
Route::delete('crisis/{crisis}', 'ReportCrisisController@destroy');
