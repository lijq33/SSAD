                            ...
                            <b-row>
                                <b-col>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div
                                                            class="tw-text-red"
                                                            v-if="error['telephoneNumber'] != undefined"
                                                        >
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-check">
                                                    <input
                                                        ...
                                                        v-model="form.assistanceRequired"
                                                        value="1"
                                                    >
                                                    <label
                                                        class="form-check-label"
                                                        for="Emergency Ambulance"
                                                    >Emergency Ambulance</label>
                                                </div>
                                                <div class="form-check">
                                                    <input
                                                        class="form-check-input"
                                    ...
                                    <div>
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="tw-full tw-flex tw-justify-between tw-pb-2">
                                                ...
                                                <div class="tw-flex tw-justify-center tw-items-center">
                                                    <div v-if="image === ''">
                                                        <input
                                                            accept="image/*"
                                                            type="file"
                                                            class="upload-image-input tw-hidden"
                                                            @change="onFileSelected"
                                                        >
                                                    </div>

                                                    <div class="tw-shadow-outline tw-h-32 tw-overflow-hidden" v-else>
                                                        <img
                                                            :src="image"
                                    ...
                                    <div>
                                        <div class="card tw-mb-6">
                                            <div class="card-body">
                                                ...
                                                <b-form-select
                                                    v-model="form.crisisType"
                                                    :options="options"
                                                    :class="{ 'tw-border-red-light' : error['crisisType'] != undefined}"
                                                />
                                                <div
                                                    class="tw-text-red"
                                                    v-if="error['crisisType'] != undefined"
                                                >
                            ...
                            <div class = "card">
                                <div class = "card-body">
                                    ...
                                    <textarea v-model = "form.description"
                                        class = "form-control" rows = "5" style = "max-width:100%; height:80%"
