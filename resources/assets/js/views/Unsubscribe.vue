        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card tw-mb-6">
                    ...
                    <div class="card-header tw-text-grey-darker">Unsubscribe to Crisis Alert</div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row tw-my-6">
                            <div class="col-md-6 offset-md-4">
                                <div v-if = "!isLoading">
                                    <button type="submit" class="btn btn-primary" @click ="unsubscribe()" >
                                        Unsubscribe
                                    </button>
                                </div>
                                <div v-else>
    ...
    export default {
        ...
        methods: {
            unsubscribe() {
                ...
                axios.post("/api/auth/subscriber/delete", this.form)
                .then(response => {
